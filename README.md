...
> ### 🔥 **ARISTA MATRIX PIPELINE** یک سیستم پیشرفته و بهینه‌شده برای اسکن، شناسایی و رتبه‌بندی سرورهای Proxy و CDN است. 
> 
> این پروژه با استفاده از معماری Pipeline، به صورت مرحله‌ای IP‌ها را از منابع مختلف جمع‌آوری، پالایش، اسکن و نهایتاً بهترین سرورها را بر اساس معیارهای متعدد رتبه‌بندی می‌کند.
>
> ### ✨ **قابلیت استخراج دوطرفه:**
> - **استخراج دامنه از IP**: با بررسی گواهی SSL، هدرها و محتوای HTML
> - **استخراج IP از دامنه**: با استفاده از Reverse DNS و رکوردهای A
